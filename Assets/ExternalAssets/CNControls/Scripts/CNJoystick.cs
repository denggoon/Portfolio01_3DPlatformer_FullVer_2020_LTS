...
//            differenceVector.Normalize(); 
			//여기서 노말라이즈를 해버리면 조이스틱이 나중에 크기가 커질때 
			//조이스틱 범위 안에서 노는것이 조이스틱 밖으로 나간 값보다 커지는 문제가 생깁니다. 
			//예를들어 cnJoystick이 2짜리 크기이고 DragRadius가 2 일때 axis는 -2, 2 까지 값을 뽑아낼수 있으나 범위를 벗어나면 1로 클램핑 되어버립니다. 
