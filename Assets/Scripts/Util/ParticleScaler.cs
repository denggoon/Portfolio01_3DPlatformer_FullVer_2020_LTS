...
public class ParticleScaler : MonoBehaviour 
{
	...
	void ScaleShurikenSystems(float scaleFactor)
	{
		...
		foreach (ParticleSystem system in systems)
		{
			...
			float speedMultiplier = main.startSpeedMultiplier;
			float sizeMultiplier = main.startSizeMultiplier;
			float gravityMultiplier = main.gravityModifierMultiplier;

			main.startSpeed = speedMultiplier* scaleFactor;
			main.startSize = sizeMultiplier* scaleFactor;
			main.gravityModifier = gravityMultiplier * scaleFactor;
	...
	void ScaleLegacySystems(float scaleFactor)
	{
		...
		foreach (ParticleEmitter emitter in emitters)
		{
			...
			//some variables cannot be accessed through regular script, we will access them through a serialized object
