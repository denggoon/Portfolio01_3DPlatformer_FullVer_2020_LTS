...
//			var oldBankPath = Application.dataPath + "/StreamingAssets/" + fileInfo.Name;
			var oldBankPath = Application.dataPath + "/StreamingAssets/banks/" + fileInfo.Name;
...
//			System.IO.Directory.CreateDirectory(Application.dataPath + "/StreamingAssets");
			System.IO.Directory.CreateDirectory(Application.dataPath + "/StreamingAssets/banks");
//			var oldBankPath = Application.dataPath + "/StreamingAssets/" + fileInfo.Name;
			var oldBankPath = Application.dataPath + "/StreamingAssets/banks/" + fileInfo.Name;
...
//		System.IO.File.WriteAllText(Application.dataPath + "/StreamingAssets/FMOD_bank_list.txt", bankNames);
		System.IO.File.WriteAllText(Application.dataPath + "/StreamingAssets/banks/FMOD_bank_list.txt", bankNames);
...
//	    string bankPath = Application.dataPath + "/StreamingAssets";
		string bankPath = Application.dataPath + "/StreamingAssets/banks";
